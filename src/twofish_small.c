...
static uint32_t g_func(uint32_t x, twofish256_key *key)
{
...
void twofish256_encrypt(const unsigned char *in, unsigned char *out, twofish256_key *key)
{
	...
	((uint32_t*)out)[0] = v[2] ^ key->K[4];
	((uint32_t*)out)[1] = v[3] ^ key->K[5];
	((uint32_t*)out)[2] = v[0] ^ key->K[6];
	((uint32_t*)out)[3] = v[1] ^ key->K[7];
}
...
void twofish256_decrypt(const unsigned char *in, unsigned char *out, twofish256_key *key)
{
	...
	v[0] = ((uint32_t*)in)[0] ^ key->K[4];
	v[1] = ((uint32_t*)in)[1] ^ key->K[5];
	v[2] = ((uint32_t*)in)[2] ^ key->K[6];
    v[3] = ((uint32_t*)in)[3] ^ key->K[7];
	...
	((uint32_t*)out)[0] = v[2] ^ key->K[0];
	((uint32_t*)out)[1] = v[3] ^ key->K[1];
	((uint32_t*)out)[2] = v[0] ^ key->K[2];
	((uint32_t*)out)[3] = v[1] ^ key->K[3];
}
